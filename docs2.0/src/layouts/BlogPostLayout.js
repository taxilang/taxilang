...
export function GoBack({link}) {
  return (<div className="flex px-4 pt-8 pb-10 lg:px-8">
    <Link href={link}>
      <a
        ...
        <div className="max-w-3xl mx-auto pb-28">
          <main>
            <article className="relative pt-10">
              ...
              {meta.imageUrl && meta.displayImageInPost ? (
                <Image src={meta.imageUrl} alt='Changelog entry cover image'
                       sizes="560px"
