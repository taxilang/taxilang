...
function CopyButton({code}) {
  ...
  return (
    <div className="relative flex -mr-2">
      ...
      >
        <Alert
          className="relative bg-sky-500 text-white font-mono text-[0.625rem] leading-6 font-medium px-1.5 rounded-lg">
          Copied
          <svg
            aria-hidden="true"
            width="16"
...
function Code({code, lang, pad}) {
  ...
  return (
    ...
    >
      <code
        className={clsx('flex-none min-w-full', pad && 'p-5', `language-${lang}`)}
