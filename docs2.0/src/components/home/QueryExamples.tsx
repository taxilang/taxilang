...
as {
 ...
 name: concat(CustomerFirstName, ' ', CustomerLastName)
    ...
    lines: [
      {
        from: () => Array.from(document.getElementsByClassName('token keyword')).filter((t: HTMLElement) => t.innerText === 'Customer[]')[0],
        ...
        <div className={'flex flex-col items-center'}>
          <div className='max-w-3xl mx-auto flex flex-col items-center'>
            <BigText className='text-center font-brand pb-4'>
              <span className='text-citrus'>Connect</span><Widont> everything.</Widont>
            </BigText>
            <Paragraph>
