...
export default function WatchADemoButton(props) {
    ...
    return (
        <>
            ...
            <button
                className='bg-midnight-blue hover:bg-slate-700 color-white text-white font-bold h-12 px-6
                rounded-lg border-2 border-white w-60 min-w-[220px] flex sm:flex-1 items-center justify-center'
