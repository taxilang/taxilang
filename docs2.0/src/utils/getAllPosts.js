function importAll(r) {
  return r
    ...
    .filter((p) => p.module.meta && p.module.meta.private !== true)
...
export function getAllChangelogPreviews() {
  return importAll(require.context('../pages/changelog/?preview', true, /\.mdx$/))
}

export function getAllChangelogEntries() {
  return importAll(require.context('../pages/changelog/?rss', true, /\.mdx$/))
}
