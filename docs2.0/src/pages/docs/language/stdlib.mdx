...
<PlaygroundSnippet scenario={{
  "schema" : "model User {\n   username: Name inherits String\n   isAdmin: IsAdmin inherits Boolean\n   isEditor: IsEditor inherits Boolean\n   isViewer: IsViewer inherits Boolean\n}\ntype HasNoAccess inherits Boolean by noneOf(IsAdmin, IsEditor, IsViewer)",
...
#### Examples
This example demonstrates parsing a JSON string embedded in a field into a structured type.
...
This example shows that computed fields on the target type are evaluated after parsing.
