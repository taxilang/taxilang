...
import AnnotateAndQuerySection from "@/components/home/AnnotateAndQuery";
      ...
      <header className='relative'>
        <div className='sm:px-6 md:px-8 dark:bg-midnight-blue'>
          ...
          <div className='max-w-8xl mx-auto sm:pt-16 md:py-32 relative'>
            ...
            <DataPatternLight
              className='sm:hidden md:left-80 lg:left-auto lg:right-0 absolute top-[380px] md:top-[480px] w-[900px] lg:w-[900px] fill-black dark:fill-sky-100 pointer-events-none -z-1'></DataPatternLight>
...
export default function Home({
                               publishYourApiHighlightedSnippets, queryExampleCodeHighlightedSnippets, microserviceHighlightedSnippets
                             }) {
  ...
  return (
    <>
      ...
      <div className='overflow-hidden sm:mb-32 md:mb-40'>
        <AnnotateAndQuerySection className="py-10" highlightedSnippets={microserviceHighlightedSnippets} />
