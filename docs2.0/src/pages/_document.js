    ...
    return (
      <Html lang="en" className="dark [--scroll-mt:9.875rem] lg:[--scroll-mt:6.3125rem]">
        <Head>
          ...
          <link
            href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;800&family=Manrope:wght@200;300;400&family=Google+Sans+Code:ital,wght@0,300..800;1,300..800&display=swap"
            rel="stylesheet"/>
        ...
        <body
          className={clsx('antialiased text-slate-500 dark:text-slate-400', {
            'bg-white dark:bg-brand-background': !this.props.dangerousAsPath.startsWith('/examples/'),
          })}
        >
        <Main/>
        <NextScript/>
