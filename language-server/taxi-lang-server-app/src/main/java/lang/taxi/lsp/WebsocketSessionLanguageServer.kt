...
import lang.taxi.lsp.sourceService.NoOpWorkspaceSourceService
 ...
 */
class WebsocketSessionLanguageServer(private val session: WebSocketSession) {
    ...
    private val languageServer = TaxiLanguageServer(
        workspaceSourceServiceFactory = NoOpWorkspaceSourceService.Companion.Factory()
    )
