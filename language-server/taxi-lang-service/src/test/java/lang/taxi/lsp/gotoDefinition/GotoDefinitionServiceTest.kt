...
object GotoDefinitionServiceSpec : Spek({
    describe("goto definition") {
        it("should provide the correct link for a type") {
            ...
            val locations = service.definition(DefinitionParams(
            ...
            location.range.start.line.should.equal(15)
            location.range.start.character.should.equal(26)
        }
    }
})