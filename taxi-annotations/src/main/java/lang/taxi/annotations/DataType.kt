...
annotation class DataType (
   ...
   /**
    * Indicates that code generators that see this annotation should
    * import the type, rather than declaring it.
    *
    * Library authors who are packing types with @DataType annotations should
    * declare this as true, so that consumers import the type from a schema, rather than
    * redeclare it.
    *
    * If the annotation is on type that is being autogenerated to be published (eg., to Vyne), then
    * this should be set to false.
    */
   val imported: Boolean = false,

   /**
    * Markdown docs describing this type
    */
