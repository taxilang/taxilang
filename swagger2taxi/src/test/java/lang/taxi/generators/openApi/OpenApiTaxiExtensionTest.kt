            ...
            expectToCompileTheSame(
               ...
               expected = listOf(
                  ...
                  namespace vyne.openApi {
                     ...
                     @ServiceDiscoveryClient(serviceName = "http://petstore.swagger.io/api")
                     service PetsService {
                     ...
                     service PetsIdService {
                        ...
                        operation find_pet_by_id(  @PathVariable(value = "id") id : PetId ) : Pet

                        [[ deletes a single pet based on the ID supplied ]]
                        @HttpOperation(method = "DELETE" , url = "/pets/{id}")
                        operation deletePet(  @PathVariable(value = "id") id : PetId )
                     }
                  }
                  """.trimIndent()
               )
