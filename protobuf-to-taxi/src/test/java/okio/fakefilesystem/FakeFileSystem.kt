...
// This is a copy of https://github.com/square/okio/blob/master/okio-fakefilesystem/src/commonMain/kotlin/okio/fakefilesystem/FakeFileSystem.kt
// but back-ported to work with an older version of kotlin
      ...
      class File(createdAt: Instant) : Element(createdAt) {
         ...
         override val metadata: FileMetadata
            get() = FileMetadata(
               ...
               lastModifiedAtMillis = lastModifiedAt.toEpochMilli(),
               lastAccessedAtMillis = lastAccessedAt.toEpochMilli(),
               extras = extras,
            )
      }
