...
Calculations are defined after the type, in the form of `... by (A operator B)`
...
|-----------------|-------------|---------------|--------------------------------------------------------------|
| String + String | String      | Concatenation | `fullName : FullName by (this.firstName + this.lastName)`    |
