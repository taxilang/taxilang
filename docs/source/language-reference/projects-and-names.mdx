...
import { Hint, Prefer, Warn } from "../components/hint";
...
<Hint>
   ...
   <br />
   <Warn>namespace People</Warn>
</Hint>
<Hint>
   Where there's a choice between singular and plural, prefer naming namespaces
   after plurals
   <br />
   <Prefer>namespace people</Prefer>
   <br />
   <Warn>namespace person</Warn>
</Hint>
