...
<Hint>
   If you're editing your `taxi.conf` file in VSCode using our plugin, saving
   changes to your `taxi.conf` will trigger the download of any dependencies.
   <br />
   <br />
   However, be aware that where most other changes in VS Code take place as you type,
   downloading of dependencies requires you to save the file first.
</Hint>
